...
public class Game extends JFrame implements Runnable
{
    ...
    public Game() 
    {
        ...
        //testSprite = sheet.getSprite(6, 4);
        
        testRectangle.generateGraphics(5, 12234);
    ...
    public void leftClick (int x, int y) {
        ...
        //System.out.println(mouseRectangle.toString());
        ...
        if(!stoppedChecking) {
            ...
            /*System.out.println("x = " + x + " renderer.getCamera().x = " + renderer.getCamera().x
            + " y = " + y + ": renderer.getCamera().y = " + renderer.getCamera().y);*/
    ...
    public void render() {
            ...
            graphics.dispose();
            bufferStrategy.show(); //Makes the next available buffer visible
            renderer.clear();
    }
    ...
    public void run() {
        ...
        //16,666,666.66666667         1,000,000,000
        ...
        while(true) {
            ...
            long now = System.nanoTime();
                   ...
                   //(1,001,000,000 - 1,000,000,000) / 16,666,666.66666667 = 0.06
            changeInSeconds += (now - lastTime) / nanoSecondConversion;
            while(changeInSeconds >= 1) {
                //Happens the same time on every computer. Keeps the game at the same speed on all computers
                //Updates variables based on how much the time has changed
                update();
                changeInSeconds = 0;
            }
            //Happens as often as possible on every computer
            render();
            lastTime = now;
        }
